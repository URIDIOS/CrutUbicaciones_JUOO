<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formUbicaciones.aspx.cs" Inherits="CrutUbicaciones_JUOO.formUbicaciones" %>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="exampleInputEmaill">Ubicacion</label>
                    ...
                    <!--Latitud y Longitud -->
                    <div class="form-group">
                        <label for="ExampleImputPassword1">lat.:</label>
    ...
    <script>
        $('#ModalMapPreview').locationpicker({
            ...
            inputBinding: {
                ...
                locationNameImputo: $('#<%=txtUbicacion.ClientID%>')
